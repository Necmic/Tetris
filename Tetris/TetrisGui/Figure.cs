...
namespace Tetris
{
    abstract class Figure
    {
        ...
        public Result TryMove(Direction dir, bool t = false)
        {
            if (t) Console.WriteLine("Timer_1_0");
            Hide();
            if (t) Console.WriteLine("Timer_1_1");
            Move(dir);
            if (t) Console.WriteLine("Timer_1_2");

            var result = VerifyPosition();
            if (t) Console.WriteLine("Timer_1_3");
            if (result != Result.SUCCESS)
                Move(Reverse(dir));
            if (t) Console.WriteLine("Timer_1_4");

            Draw();
            if (t) Console.WriteLine("Timer_1_5");
            return result;
        }
